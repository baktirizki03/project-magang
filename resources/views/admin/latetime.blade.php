...
@section('breadcrumb')
<div class="col-sm-6">
    <h4 class="page-title text-left">Keterlambatan</h4>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:void(0);">Home</a></li>
        <li class="breadcrumb-item"><a href="javascript:void(0);">Keterlambatan</a></li>
...
@section('button')
<a href="/attendance" class="btn btn-primary btn-sm btn-flat"><i class="mdi mdi-plus mr-2"></i>Kehadiran Table</a>
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-priority="4">Keterlambatan Duration</th>
