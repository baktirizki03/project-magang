...
@section('breadcrumb')
    <div class="col-sm-6">
        <h4 class="page-title text-left">Lembur</h4>
        <ol class="breadcrumb">
...
@endsection
@section('button')
    <a href="/leave" class="btn btn-primary btn-sm btn-flat"><i class="mdi mdi-table mr-2"></i>Keluar Table</a>
